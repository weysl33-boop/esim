...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function () {
        ...
        Route::get('chart/deposit', 'depositAndWithdrawReport')->name('chart.deposit.withdraw');
    ...
    Route::controller('CountryController')->prefix('country')->name('destination.country.')->group(function () {
        Route::get('all', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('toggle-feature/{id}', 'toggleFeature')->name('toggle.feature');
        Route::post('change-status', 'changeStatus')->name('change.status');
        Route::post('fetch-countries', 'fetchCountries')->name('fetch.all');
    });

    Route::controller('RegionController')->prefix('region')->name('destination.region.')->group(function () {
        Route::get('all', 'index')->name('index');
        Route::post('update/{id}', 'update')->name('update');
        Route::post('change-status/{id}', 'changeStatus')->name('change.status');
        Route::post('change-bulk-status', 'changeBulkStatus')->name('change.bulk.status');
        Route::post('fetch-regions', 'fetchRegions')->name('fetch.all');
    });

    Route::controller('PlanController')->prefix('plan')->name('plan.')->group(function () {
        Route::get('all', 'plans')->name('all');
        Route::get('detail/{id}', 'detail')->name('detail');
        Route::get('local', 'local')->name('local');
        Route::get('global', 'global')->name('global');
        Route::get('other', 'continental')->name('continental');
        Route::post('change-status', 'changeStatus')->name('change.status');
        Route::post('toggle-feature', 'toggleFeature')->name('toggle.feature');

        Route::post('update/retail-price/{id}', 'updateRetailPrice')->name('update.retail.price');
    });

    Route::controller('EsimController')->prefix('esim')->name('esim.')->group(function () {
        Route::get('all/{user_id?}', 'all')->name('all');
        Route::get('active/{user_id?}', 'active')->name('active');
        Route::get('expired/{user_id?}', 'expired')->name('expired');
    });

    Route::controller('EsimProviderController')->prefix('provider/esim')->name('provider.esim.')->group(function () {
