...
class UserController extends Controller {
    public function home() {
        ...
        $widget['pending_orders'] = Order::pending()->where('user_id', auth()->id())->count();

        $transactions = Transaction::where('user_id', $user->id)->orderBy('id', 'desc')->limit(6)->get();

        return view('Template::user.dashboard', compact('pageTitle', 'widget', 'transactions'));
    }

    public function depositHistory(Request $request) {
        $pageTitle = 'Deposit History';
        $deposits  = Deposit::where('status', '!=', Status::PAYMENT_INITIATE)
