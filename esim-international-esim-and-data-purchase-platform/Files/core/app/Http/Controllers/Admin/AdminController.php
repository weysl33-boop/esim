...
class AdminController extends Controller {
    ...
    public function dashboard() {
        ...
        $widget['total_esim_users']       = Esim::count();
        $widget['total_active_regions']   = Region::active()->count();
        $widget['total_active_plans']     = Plan::active()->count();
        $widget['total_active_countries'] = Country::active()->count();
        ...
        $esim['total_orders']      = Order::count();
        $esim['total_pending_orders']      = Order::pending()->count();
        $esim['total_active_esims']       = Esim::active()->count();
        $esim['total_revenue_from_esims'] = OrderItem::sum('price') - OrderItem::sum('paid_price');

        return view('admin.dashboard', compact('pageTitle', 'widget', 'chart', 'deposit', 'esim'));
    }
