...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        ...
        $general->referral_amount   = $request->referral_amount ?? 0;
        $general->additional_price  = $request->additional_price ?? 0;
        $general->additional_topup_price  = $request->additional_topup_price ?? 0;
        $general->refund_charge     = $request->refund_charge ?? 0;
    ...
    public function systemConfigurationSubmit(Request $request)
    {
        ...
        $general->topup_enabled  = $request->topup_enabled ? Status::ENABLE : Status::DISABLE;
        $general->refund_system_enabled  = $request->refund_system_enabled ? Status::ENABLE : Status::DISABLE;
        $general->save();
