...
<head>
    ...
    <link rel="stylesheet" href="{{ asset(activeTemplate(true) . 'css/lightcase.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset(activeTemplate(true) . 'css/aos.css') }}">
...
<body>
    ...
    <script src="{{ asset(activeTemplate(true) . 'js/aos.js') }}"></script>
            ...
            Array.from(document.querySelectorAll('table')).forEach(table => {
                ...
                Array.from(table.querySelectorAll('tbody tr')).forEach(row => {
                    Array.from(row.querySelectorAll('td')).forEach((column, i) => {
                        (column.colSpan == 100) || column.setAttribute('data-label',
                            heading[i].innerText)
                    });
                });
            });

            $('#confirmationModal').find('.btn').addClass('btn--xsm');
