                ...
                <form method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Topup Option')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can top-ups for their eSIM (Also depends on eSIM provider plans).')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="topup_enabled" @if (gs('topup_enabled')) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Refund Option')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, users can refund for refundable (depends on eSIM provider plans) eSIMs after purchased.')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="refund_system_enabled" @if (gs('refund_system_enabled')) checked @endif>
                                </div>
                            </li>
                        </ul>
                    </div>
