    ...
    <div class="row">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="7" link="{{ route('admin.esim.active', $user->id) }}" title="Active eSIMs" icon="las la-sim-card" value="{{ $totalEsim }}" bg="info" type="2" />
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" data-width="100%" data-height="50" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-on="@lang('Verified')"
