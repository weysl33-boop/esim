...
class CustomSnackBar {
  static void error({required List<String> errorList, int duration = 3}) {
    String message = '';
  ...
  static void success({required List<String> successList, int duration = 3, BuildContext? context}) {
    String message = '';
